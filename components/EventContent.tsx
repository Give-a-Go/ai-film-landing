...
function SectionLabel({ no, title }: { no: string; title: string }) {
  return (
    ...
    >
      ...
      <div style={{ flex: 1, height: 1, background: T.border, maxWidth: 120 }} />
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        background: 'radial-gradient(ellipse at 100% 28%, rgba(255,200,60,0.045) 0%, transparent 68%)',
        pointerEvents: 'none',
        zIndex: 1,
      }} />
      ...
      >
        ...
        >
          {([
            [0, 1], [2, 1], [4, 2], [7, 1], [10, 2], [13, 1], [15, 2], [18, 1],
            [20, 2], [23, 1], [25, 2], [28, 1], [30, 2], [33, 1], [35, 2], [38, 1],
            [40, 2], [43, 1], [46, 2], [49, 1], [51, 2], [54, 1], [56, 2], [59, 1],
            [62, 2], [65, 1], [67, 2], [70, 1], [72, 2], [75, 1], [78, 1], [80, 2],
          ] as [number, number][]).map(([y, h], i) => (
            <rect
              key={i}
              x={0}
              y={y}
  ...
  return (
    <div ref={ref}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1.25rem', marginBottom: "1.75rem" }}>
        <div style={{
          flex: '0 0 80px', height: 1, background: "rgba(200,170,80,0.25)",
          transform: visible ? "scaleX(1)" : "scaleX(0)", transformOrigin: "right",
          transition: "transform 1.4s cubic-bezier(0.16,1,0.3,1)",
        }} />
        <div style={{
          fontFamily: T.mono, fontSize: "0.55rem", letterSpacing: "0.55em",
          color: "rgba(200,170,80,0.35)", textTransform: "uppercase",
      ...
      <button
        ...
        style={{
          ...
          boxShadow: "0 0 40px rgba(198,153,58,0.12), 0 2px 12px rgba(0,0,0,0.5)",
  ...
  return (
    ...
    >
      ...
      {/* ════════════════════════════════════════════════════════════════════
          ...
          ════════════════════════════════════════════════════════════════════ */}
      <SectionReveal>
        <div className="ec-manifesto-card" style={{
          ...
          <p style={{
            ...
            "You walk in on Saturday morning. By Sunday afternoon, your film
            is on a cinema screen. You made it. It didn't exist 24 hours ago."
          </p>
          <p style={{
            fontFamily: T.sans,
            ...
            you do. We give you the tools, the equipment, the workshops, and
            the time. AI handles what used to need a full crew and months of
            post. You bring the story, the instincts, and the drive to see it
            through. Dublin, April. One weekend. A film that's yours.
          </p>
        </div>
      </SectionReveal>
      ...
      >
        ...
        >
            ...
            <SectionReveal delay={0.05}>
              <h1
                style={{
                  ...
                  margin: "0 0 1.5rem",
                  textShadow: "0 0 40px rgba(255,215,60,0.28), 0 4px 120px rgba(255,200,40,0.18), 0 -2px 60px rgba(255,230,100,0.12)",
                }}
              >
                The Shot Didn't
                <br />
          ...
          >
            ...
            <InfoCard label="Date" value="18–19 Apr 2026" sub="Saturday & Sunday" />
            <InfoCard
              label="Venue"
              value="Dogpatch Labs"
      ...
      {/* ════════════════════════════════════════════════════════════════════
          ...
          ════════════════════════════════════════════════════════════════════ */}
      <section style={{ maxWidth: 1160, margin: "0 auto", padding: "0 2.5rem 6rem" }}>
        <SectionReveal>
          <div style={{
            fontFamily: T.mono,
            fontSize: "0.55rem",
        ...
        <div style={{
          ...
          {[
            {
              role: "The Filmmaker",
              description: "You've shot things. You know pacing, you know story, you know when a frame is wrong. You've never had tools like these.",
              cue: "Bring your eye.",
            },
            {
              role: "The Engineer",
              description: "You build things fast. You know what these models can do — and you've been waiting for a reason to push them somewhere creative.",
              cue: "Bring your instincts.",
            },
            {
              role: "The Editor",
              description: "You live in the cut. You know that a film is made three times — in writing, on set, and in the edit. You're about to do all three in one day.",
              cue: "Bring your taste.",
            },
            {
              role: "The Designer",
              description: "You think in frames, in mood, in visual language. You've always had something cinematic in you. This is the reason to go there.",
      ...
      >
        ...
        <div className="ec-credits-stack" style={{ display: "flex", flexDirection: "column", gap: "3.2rem" }}>
          <SectionReveal delay={0.1}>
            <div className="ec-credits-row">
              ...
              <div className="ec-credits-logos">
                <a href="https://elevenlabs.io" target="_blank" rel="noopener noreferrer"><img className="ec-credit-logo" src="/partners/elevenlabs-logo-white.svg" alt="ElevenLabs" /></a>
                <a href="https://wan.video" target="_blank" rel="noopener noreferrer"><img className="ec-credit-logo" src="/partners/wan.png" alt="Wan" /></a>
                <a href="https://fal.ai" target="_blank" rel="noopener noreferrer"><img className="ec-credit-logo ec-credit-logo--invert" src="/partners/fal-ai.svg" alt="fal.ai" /></a>
                <a href="https://wolfpackdigital.com" target="_blank" rel="noopener noreferrer"><img className="ec-credit-logo" src="/partners/wolfpack-digital-light.png" alt="Wolfpack Digital" /></a>
              </div>
            </div>
          </SectionReveal>

          <div className="ec-credits-divider" style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
            <div style={{ flex: 1, height: 1, background: "linear-gradient(90deg, transparent, rgba(220,185,90,0.24))" }} />
            <ReelIcon />
            <div style={{ flex: 1, height: 1, background: "linear-gradient(90deg, rgba(220,185,90,0.24), transparent)" }} />
          </div>
          ...
          <SectionReveal delay={0.2}>
            <div className="ec-credits-row">
              ...
              <div className="ec-credits-logos">
                <a href="https://www.redbull.com" target="_blank" rel="noopener noreferrer"><img className="ec-credit-logo" src="/partners/redbull.png" alt="Red Bull" /></a>
              </div>
            </div>
          </SectionReveal>
      ...
      {/* ════════════════════════════════════════════════════════════════════
          AWARDS
          ════════════════════════════════════════════════════════════════════ */}
      <section style={{ maxWidth: 1160, margin: "0 auto", padding: "5rem 2.5rem" }}>
        <SectionReveal>
          <SectionLabel no="03" title="The Awards" />
        </SectionReveal>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "start" }} className="ec-overview-grid">
          <SectionReveal delay={0.05}>
            <h2 style={{ fontFamily: T.serif, fontSize: "clamp(2rem,4vw,3rem)", fontWeight: 700, color: T.gold, lineHeight: 1.1, margin: "0 0 1.25rem" }}>
              Films will be<br /><span style={{ fontWeight: 300, fontStyle: "italic" }}>judged and awarded.</span>
            </h2>
            <p style={{ fontFamily: T.sans, fontSize: "0.95rem", color: "rgba(255,255,255,0.42)", lineHeight: 1.8, margin: "0 0 2.5rem" }}>
              On Day 2, a panel of judges from the film and technology world will
              select winners across categories. Awards to be announced in the
              run-up to the event.
            </p>
            <div style={{ fontFamily: T.mono, fontSize: "0.55rem", letterSpacing: "0.25em", color: "rgba(200,170,80,0.4)", textTransform: "uppercase" }}>
          ...
          <SectionReveal delay={0.1}>
            <div style={{ display: "flex", flexDirection: "column", gap: "1px" }}>
              {[
                { cat: "Best Film", desc: "The complete package — story, execution, and impact." },
                { cat: "Best Direction", desc: "The clearest creative vision brought to screen." },
                { cat: "Best Use of AI", desc: "The most inventive, unexpected application of the tools." },
                { cat: "Best Score & Sound", desc: "Audio that makes the film feel bigger than it is." },
                { cat: "People's Choice", desc: "Voted by the room on premiere night." },
              ].map((a) => (
                <div key={a.cat} style={{
                  display: "flex", alignItems: "baseline", gap: "1.25rem",
                  padding: "1.1rem 1.25rem", border: `1px solid ${T.border}`,
                  background: T.cardBg,
                }}>
                  <div style={{ fontFamily: T.serif, fontSize: "0.95rem", fontWeight: 600, color: T.gold, whiteSpace: "nowrap", minWidth: 130 }}>{a.cat}</div>
                  <div style={{ fontFamily: T.sans, fontSize: "0.8rem", color: "rgba(255,255,255,0.38)", lineHeight: 1.5 }}>{a.desc}</div>
                </div>
              ))}
              <div style={{
                padding: "1rem 1.25rem", border: `1px solid ${T.border}`,
                fontFamily: T.mono, fontSize: "0.52rem", letterSpacing: "0.2em",
                color: "rgba(200,170,80,0.3)", textTransform: "uppercase",
                textAlign: "center",
              }}>
      ...
      <section style={{
          ...
          <SectionReveal delay={0.05}>
            <div>
              ...
              <p style={{
                ...
                scores, and actual emotional weight. Then they screened them
                in a room full of people who'd watched them get made.
              </p>
              <a
                ...
                onMouseEnter={(e) => {
                  (e.currentTarget as HTMLElement).style.color = T.gold;
                  (e.currentTarget as HTMLElement).style.borderColor = "rgba(200,170,80,0.6)";
                }}
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLElement).style.color = "rgba(200,170,80,0.7)";
          ...
          <SectionReveal delay={0.05}>
            <div style={{
              ...
              <span style={{
                ...
                textTransform: "uppercase",
                color: "rgba(200,170,80,0.5)",
              }}>V1 Winning Films</span>
              <div style={{ flex: 1, height: 1, background: "rgba(200,170,80,0.15)" }} />
            </div>
          </SectionReveal>
          {/* Film strip wrapper */}
          <div style={{ position: "relative" }}>
            ...
            {["top", "bottom"].map((pos) => (
              <div key={pos} style={{
                ...
                height: 22,
                background: "#000",
                borderTop: pos === "top" ? `1px solid rgba(200,170,80,0.18)` : "none",
                borderBottom: pos === "bottom" ? `1px solid rgba(200,170,80,0.18)` : "none",
                display: "flex",
                alignItems: "center",
                paddingLeft: 6,
                gap: 6,
            ...
            {[
              { award: "Best Film", title: "Watch Short Film", team: "V1 · 2025", href: "https://www.youtube.com/watch?v=-AWdaaZwG2g", thumb: "https://img.youtube.com/vi/-AWdaaZwG2g/hqdefault.jpg" },
              { award: "Best Use of AI", title: "Watch Short Film", team: "V1 · 2025", href: "https://www.youtube.com/watch?v=Cqe3y_rpYe4", thumb: "https://img.youtube.com/vi/Cqe3y_rpYe4/hqdefault.jpg" },
              { award: "People's Choice", title: "Watch Short Film", team: "V1 · 2025", href: "https://www.youtube.com/watch?v=qfPQ3Kw1img", thumb: "https://img.youtube.com/vi/qfPQ3Kw1img/hqdefault.jpg" },
              ...
              <SectionReveal key={award} delay={0.05 + i * 0.08}>
                <a
                  ...
                  style={{
                    ...
                    position: "relative",
                    aspectRatio: "3/4",
                    borderRight: i < 2 ? `1px solid rgba(200,170,80,0.15)` : "none",
                    background: "#050505",
                    overflow: "hidden",
                    textDecoration: "none",
                    cursor: "pointer",
                  ...
                  onMouseEnter={(e) => {
                    (e.currentTarget as HTMLElement).style.borderColor = "rgba(200,170,80,0.4)";
                    const overlay = (e.currentTarget as HTMLElement).querySelector(".film-card-overlay") as HTMLElement;
                ...
                >
                  ...
                  <div style={{
                    position: "absolute",
                    inset: 0,
                    background: "linear-gradient(to bottom, rgba(0,0,0,0.25) 0%, rgba(0,0,0,0.1) 40%, rgba(0,0,0,0.6) 100%)",
                    zIndex: 1,
                  }} />
                  {/* Award badge */}
                  <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <path d="M5 3l10 5-10 5V3z" fill="rgba(220,185,90,0.9)" />
                      </svg>
                    </div>
                  </div>
                  {/* Hover overlay */}
                  <div className="film-card-overlay" style={{
                    position: "absolute",
                    inset: 0,
            ...
            </div>{/* end ec-winner-grid */}
          </div>{/* end film strip wrapper */}
        </div>
        ...
        <div style={{ marginTop: "4.5rem" }}>
          ...
          <div style={{
            ...
            {[
              {
                quote: "This is what community and innovation are all about. It was fantastic to see such a brilliant mix of creatives and engineers come together. We were thrilled to be involved. Congratulations!",
                name: "V1 Partner",
                role: "Supporting Organisation",
              },
              {
                quote: "AI Film Hackathon was as brilliant as it was challenging! As someone heading into it with limited experience of AI tools — it was a case of try, fail, learn, repeat... on speed!",
                name: "V1 Participant",
                role: "First-Time AI Filmmaker",
              },
              {
                quote: "As someone researching generative AI, it was interesting to see how it all works from the creative side, collaborating with filmmakers and artists on making a short Halloween-themed film.",
                name: "V1 Participant",
